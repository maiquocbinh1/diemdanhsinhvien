...
class Report:
    def __init__(self,root):
        ...
        self.heading.place(x=(win_w - heading_w) // 2, y=22, width=heading_w, height=40)
        self.slider()
        self.heading_color()
        ...
        Top_frame.place(x=5, y=0, width=max(600, main_w - 10), height=120)
        #===================select_for_txt=================
        ...
        Left_frame = LabelFrame(main_frame, bd=2, bg="white",
                               font=("times new roman", 12, "bold"))
        body_y = 125
        body_h = max(320, main_h - body_y - 5)
        gap = 10
        left_w = max(420, (main_w - gap - 20) // 2)
        Left_frame.place(x=10, y=body_y, width=left_w, height=body_h)
        #topleft
        ...
        self.LateTable.column("studentid", width=120, stretch=True)
        self.LateTable.column("name", width=180, stretch=True)
        self.LateTable.column("date", width=140, stretch=True)
        self.LateTable.column("subname", width=200, stretch=True)
        self.LateTable.column("lessonid", width=120, stretch=True)
        self.LateTable.column("status", width=160, stretch=True)
        ...
        self.NoAttTable.column("studentid", width=120, stretch=True)
        self.NoAttTable.column("name", width=180, stretch=True)
        self.NoAttTable.column("date", width=140, stretch=True)
        self.NoAttTable.column("subname", width=200, stretch=True)
        self.NoAttTable.column("lessonid", width=120, stretch=True)
        self.NoAttTable.column("status", width=160, stretch=True)
        ...
        Right_frame = LabelFrame(main_frame, bd=2, bg="white",
                                font=("times new roman", 12, "bold"))
        Right_frame.place(x=10 + left_w + gap, y=body_y, width=left_w, height=body_h)
