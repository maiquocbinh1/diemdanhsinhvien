...
class Face_Recognition:
    ...
    def __init__(self,root):
        ...
        heading.place(x=(win_w - heading_w) // 2, y=20, width=heading_w, height=40)
        ...
        self.notify_frame = LabelFrame(Left_frame, bd=1, bg="white", relief=RIDGE,
                                       font=("times new roman", 11, "bold"))
        self.notify_frame.place(x=8, y=max(320, left_h - 85), width=max(400, left_w - 20), height=60)
        ...
        btn_y = min(win_h - 60, top_y + left_h + 10)
        self.btnOpen.place(x=left_x, y=btn_y, width=max(220, int(left_w * 0.48)), height=45)
        ...
        self.btnClose.place(x=left_x + max(220, int(left_w * 0.52)), y=btn_y, width=max(220, int(left_w * 0.48)), height=45)
        ...
        right_w = max(360, win_w - right_x - 40)
        self.Right_frame.place(x=right_x, y=top_y, width=right_w, height=max(320, int(left_h * 0.68)))
        ...
        self.studentID_atten_info=Label(self.Right_frame, bg="white",
                                font=("times new roman", 12, "bold"))
        self.studentID_atten_info.place(x=5, y=220, width=max(200, right_w - 10), height=130)
        ...
        self.RightU_frame = LabelFrame(self.root, bd=2, bg="white", relief=RIDGE, text="Thông tin buổi học",
                                      font=("times new roman", 12, "bold"))
        self.RightU_frame.place(x=right_x, y=top_y + max(320, int(left_h * 0.68)) + 10, width=right_w, height=max(160, int(left_h * 0.32) - 10))
