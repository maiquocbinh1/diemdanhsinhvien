...
class Lesson:
    def __init__(self,root):
        ...
        btn_frame.place(x=0, y=max(260, left_h - 300), width=max(280, left_w - 10), height=115)
        ...
        self.AttendanceReportTable.column("timestart", width=120, stretch=True)
        self.AttendanceReportTable.column("timeend", width=120, stretch=True)
        self.AttendanceReportTable.column("date", width=140, stretch=True)
        self.AttendanceReportTable.column("teacherid", width=140, stretch=True)
        self.AttendanceReportTable.column("subjectid", width=140, stretch=True)
