...
class Teacher:
    def __init__(self,root):
        ...
        btn_frame.place(x=0, y=max(220, left_h - 300), width=max(280, left_w - 10), height=115)
        ...
        self.AttendanceReportTable.column("id", width=110, stretch=True)
        self.AttendanceReportTable.column("name", width=180, stretch=True)
        self.AttendanceReportTable.column("phone", width=120, stretch=True)
        self.AttendanceReportTable.column("email", width=200, stretch=True)
        self.AttendanceReportTable.column("quest", width=220, stretch=True)
        self.AttendanceReportTable.column("answer", width=180, stretch=True)
        self.AttendanceReportTable.column("pass", width=120, stretch=True)
